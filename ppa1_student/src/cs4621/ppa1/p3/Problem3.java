	...
	
{
	...
	private static final String ADD_CONE_MENU_TEXT = "Add Cone";
	...
	{		
		...
		BasicAction addCone = new BasicAction(ADD_CONE_MENU_TEXT, this);
		...
		menu.add(new JMenuItem(addCone));
	 ...
	 */
	protected void addNewShape(Class<? extends TriangleMesh> c) 
	{		
	...
	public void actionPerformed(ActionEvent e) { 
		...
		else if (cmd.equals(ADD_CONE_MENU_TEXT)) {
			addNewShape(Cone.class);
		}
