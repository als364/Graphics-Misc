...
public class Pipeline {
	...
	public void configure(Class fpClass, Class vpClass) {
		...
		try {
			...
			rasterizer = new Rasterizer(framebuffer.getWidth(), framebuffer.getHeight());
			clipper = new Clipper();
			...
			// (Steve) we put it back in there.
			fp.updateLightModel(this);
	...
	public boolean validConfiguration() {
		...
		return fp.compatibilityIndex() == vp.compatibilityIndex();
	}
